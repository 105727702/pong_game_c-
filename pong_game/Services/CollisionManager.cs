...
namespace PongGame.Services
{
    ...
    public static class CollisionManager
    {
        ...
        public static void ResolveCollision(Ball ball, Rectangle objectBounds, PongGame.Entities.Vector2D normal = null)
        {
            ...
            float dx = (ball.X + ball.Size / 2f) - ((float)objectBounds.X + (float)objectBounds.Width / 2f);
            float dy = (ball.Y + ball.Size / 2f) - ((float)objectBounds.Y + (float)objectBounds.Height / 2f);
